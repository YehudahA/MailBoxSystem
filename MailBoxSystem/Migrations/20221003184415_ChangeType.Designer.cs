...
namespace MailBoxSystem.Migrations
{
    ...
    [Migration("20221003184415_ChangeType")]
            ...
            modelBuilder.Entity("MailBoxSystem.Models.LetterBoxStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BoxId = 1,
                            DeliverTime = new DateTime(2022, 10, 2, 21, 44, 14, 930, DateTimeKind.Local).AddTicks(9988)
                        });
                });
            ...
            modelBuilder.Entity("MailBoxSystem.Models.Package", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoxId = 2,
                            Code = "R1234",
                            CreatedDate = new DateTime(2022, 10, 3, 21, 44, 14, 931, DateTimeKind.Local).AddTicks(71),
                            DeliverTime = new DateTime(2022, 10, 3, 20, 44, 14, 931, DateTimeKind.Local).AddTicks(75),
                            RecieverName = "יהודה",
