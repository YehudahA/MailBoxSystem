...
namespace MailBoxSystem.Migrations
{
    ...
    [Migration("20221003200600_ChangeType2")]
            ...
            modelBuilder.Entity("MailBoxSystem.Models.LetterBoxStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BoxId = 1,
                            DeliverTime = new DateTime(2022, 10, 2, 23, 5, 59, 890, DateTimeKind.Local).AddTicks(5419)
                        });
                });
            ...
            modelBuilder.Entity("MailBoxSystem.Models.Package", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BoxId = 2,
                            Code = "R1234",
                            CreatedDate = new DateTime(2022, 10, 3, 23, 5, 59, 890, DateTimeKind.Local).AddTicks(5471),
                            DeliverTime = new DateTime(2022, 10, 3, 22, 5, 59, 890, DateTimeKind.Local).AddTicks(5476),
                            RecieverName = "יהודה",
